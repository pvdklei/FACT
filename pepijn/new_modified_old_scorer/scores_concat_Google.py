...
gemini_flashlite = pd.read_csv(models_path/"ScoresGoogle_Original_File_gemini_flash_lite_v1.csv")
gemini_pro_twice = pd.read_csv(models_path/"ScoresGoogle_Original_File_twice_gemini_pro_v1.csv")
flash_pro = pd.read_csv(models_path/"ScoresGoogle_Original_File_twice_gemini_flash_pro_v1.csv")
flashlite_pro = pd.read_csv(models_path/"ScoresGoogle_Original_File_twice_gemini_flash_lite_pro_v1.csv")
...
gemini_flash = gemini_flash.rename(columns={
    "Modified_gemini-3-flash-preview_of_CV_Modelgemini-3-flash-preview Google Score": "gemini_flash"
})

gemini_pro = gemini_pro.rename(columns={
    "Modified_gemini-3-pro-preview_of_CV_Modelgemini-3-pro-preview Google Score": "gemini_pro"
})

gemini_flashlite = gemini_flashlite.rename(columns={
    "Modified_gemini-2.0-flash-lite_of_CV_Modelgemini-2.0-flash-lite Google Score": "gemini_flashlite"
})

gemini_pro_twice = gemini_pro_twice.rename(columns={
    "Modified_gemini-3-pro-preview_of_CV_Modelgemini-3-pro-preview Google Score": "gemini_pro_twice"
})

flash_pro = flash_pro.rename(columns={
    "Modified_gemini-3-pro-preview_of_CV_Modelgemini-3-pro-preview Google Score": "flash_pro"
})

flashlite_pro = flashlite_pro.rename(columns={
    "Modified_gemini-3-pro-preview_of_CV_Modelgemini-3-pro-preview Google Score": "flashlite_pro"
})

target = pd.concat(
    [original_scores[["CV Google Score"]],
     gemini_flash,
     gemini_pro,
     gemini_flashlite,
     gemini_pro_twice,
     flash_pro,
     flashlite_pro,
     haiku[["Modified_claude-haiku-4-5_of_CV_Modelclaude-haiku-4-5 Google Score"]], 
     opus[["Modified_claude-opus-4-5_of_CV_Modelclaude-opus-4-5 Google Score"]], 
     sonnet[["Modified_claude-sonnet-4-5_of_CV_Modelclaude-sonnet-4-5 Google Score"]],
     haiku_opus[["Modified_claude-opus-4-5_of_Modified_claude-haiku-4-5_of_CV_Modelclaude-haiku-4-5_Modelclaude-opus-4-5 Google Score"]],
     sonnet_opus[["Modified_claude-opus-4-5_of_Modified_claude-sonnet-4-5_of_CV_Modelclaude-sonnet-4-5_Modelclaude-opus-4-5 Google Score"]],
     twice_opus[["Modified_claude-opus-4-5_of_Modified_claude-opus-4-5_of_CV_Modelclaude-opus-4-5_Modelclaude-opus-4-5 Google Score"]]],
    axis=1
)
