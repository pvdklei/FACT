...
target = pd.concat(
    [original_scores[["CV_google_ux_Score"]],
     gemini_flash[["Modified_gemini-3-flash-preview_of_CV_Modelgemini-3-flash-preview_google_ux_Score"]], 
     gemini_pro[["Modified_gemini-3-pro-preview_of_CV_Modelgemini-3-pro-preview_google_ux_Score"]], 
