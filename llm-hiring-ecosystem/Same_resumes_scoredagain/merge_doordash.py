...
column_map = {
    ...
    "ScoresDoorDash_Original_File_gpt4o_once.csv": "Cleaned GPT-4o Conversation-Improved CV DoorDash Score",
    "ScoresDoorDash_Original_File_twicegpt4o.csv": "Cleaned Twice GPT-4o Conversation-Improved CV DoorDash Score",
...
desired_order = pd.read_csv(base / "Figure1_100Samples/Scores/doordash_job_description_prev.csv", nrows=0).columns.tolist()
...
out.to_csv(src / "doordash_job_description_prev_formatted.csv", index=False)
print("Wrote:", src / "doordash_job_description_prev_formatted.csv")