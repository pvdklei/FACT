'''
This module provides functions to score resumes/CVs against inputted job descriptions, the same as "score_cv.py", but now for the Ukrainian language.
...
if __name__ == "__main__":
    ...
    for resume_path in resumes:
        print(resume_path)
        input_csv = pd.read_csv(str(resume_path), index_col=0, encoding='utf-8')
