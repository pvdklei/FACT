...
original_scores = pd.read_csv(models_path/"ScoresDoorDash_Original_File_merged.csv")
gpt4o = pd.read_csv(models_path/"ScoresDoorDash_Original_File_merged_GPT-4o1.csv")
gpt35 = pd.read_csv(models_path/"ScoresDoorDash_Original_File_merged_GPT-3.5.1.csv")
gptmini = pd.read_csv(models_path/"ScoresDoorDash_Original_File_merged_GPT-mini1.csv")
twice_4o = pd.read_csv(models_path/"ScoresDoorDash_Original_File_merged_GPT-4o2.csv")
first35_4o = pd.read_csv(models_path/"ScoresDoorDash_Original_File_merged_gpt4o-on3.5.csv")
mini_4o = pd.read_csv(models_path/"ScoresDoorDash_Original_File_merged_gpt4o-onmini.csv")
...
first35_4o = first35_4o.rename(columns={
    "Modifiedgpt4o-onmini DoorDash Score": "4o_on_35"
})

mini_4o = mini_4o.rename(columns={
    "Modifiedgpt4o-onmini DoorDash Score": "4o_on_mini"
})


target = pd.concat(
    [original_scores[["resume DoorDash Score"]],
     gpt4o,
     gptmini,
     gpt35,
     twice_4o,
